...
cb1 = DifferentialEquations.ContinuousCallback(condition_new, stochastic_collapse_new!, save_positions=(false,false))
cb2 = DifferentialEquations.DiscreteCallback(terminate_condition, terminate!)
...
cb1_diffusion = DifferentialEquations.ContinuousCallback(condition_new, stochastic_collapse_new!, save_positions=(false,false))
